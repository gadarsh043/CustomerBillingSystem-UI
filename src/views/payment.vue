      ...
      <form action="/action_page.php">
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="adr" name="address" placeholder="HSR LAYOUT">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="560021">
              </div>
            </div>
          </div>
          <div class="col-50">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="cvv" name="cvv" placeholder="786">
              </div>
            </div>
          </div>
        </div>
